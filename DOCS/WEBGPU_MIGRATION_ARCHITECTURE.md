...
2. **Shader Migration**
   ...
   - ✅ Translate the hypercube, hypersphere, and hypertetrahedron lattice fragment programs to WGSL with geometry/projection selectors driven by the new material uniform blocks.【F:src/ui/adaptive/renderers/webgpu/shaders/GlassLayerShaderBuilder.ts†L1-L312】
