...
`ParameterManager` keeps these three values synchronized so consumers can rely on either the encoded value or the discrete base/core indices.【F:src/core/Parameters.js†L8-L126】
