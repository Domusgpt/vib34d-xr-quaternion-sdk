...
export class WebGPUPreviewHarness {
  static async create(options: WebGPUPreviewHarnessOptions): Promise<WebGPUPreviewHarness> {
    ...
    const layerShaderCode = options.layerShaderCode ?? buildGlassLayerShader({ geometry, projection });
  ...
  private readonly layerShaderCode: string;
  ...
  private constructor(options: WebGPUPreviewHarnessInit) {
    ...
    this.layerShaderCode = options.layerShaderCode;
    ...
    const pipelines = createGlassPipelines({
      ...
      layerShaderCode: this.layerShaderCode,
    });
    ...
    this.layerPipeline = pipelines.layerPipeline;
