...
export class RealHolographicSystem {
    constructor() {
        ...
        this.baseVariants = GeometryLibrary.getGeometryNames().length;
        ...
        // Variant names sourced dynamically from geometry library
        this.variantNames = GeometryLibrary.getGeometryNames();
    ...
    updateVariantDisplay() {
        ...
        return {
            ...
            name: variantName,
            geometryType: this.currentVariant
        };
    }
