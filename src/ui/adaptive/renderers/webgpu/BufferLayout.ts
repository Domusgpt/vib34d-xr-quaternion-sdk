...
export const GlassUniformLayout = createStd140Layout([
  ...
  { name: 'materialScalarsA', type: 'vec4' },
  { name: 'materialScalarsB', type: 'vec4' },
  { name: 'materialScalarsC', type: 'vec4' },
  { name: 'materialPrimary', type: 'vec4' },
  { name: 'materialSecondary', type: 'vec4' },
  { name: 'materialBackground', type: 'vec4' },
]);
