import { normalizeQuaternionObject } from '../../../../core/quaternion/index.js';
...
export class WebGPUXRFrameLoop {
  ...
  handleXRFrame(time, frame) {
    ...
    const orientation = toQuaternion(transform.orientation);
    ...
    try {
      this.pipeline.updatePose({ orientation, position }, { timestamp, motionEnergy });
    } catch (error) {
