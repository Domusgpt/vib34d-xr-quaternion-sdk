...
**VIB3+ ORCHESTRATION**
- Geometry tree covering all 24 geometry/core pairings
- Centralized quaternion routing with six-plane rotation payloads
- CPU-side rotation composer builds column-major 4×4 matrices and plane-angle vectors so GPU layers can bypass redundant
  trig evaluations.
- Helper environment (`Vib3PlusEnvironment`) for rapid prototyping
- Preset variation levels per geometry/core pairing
