...
| 64-66 | Predicted translation at the configured horizon |
| 67 | Prediction horizon (seconds) |
| 68-70 | Predicted translation velocity |
| 71 | Predicted translation speed magnitude |
| 72-75 | Predicted orientation quaternion (x, y, z, w) |
| 76-78 | Predicted angular velocity vector |
| 79 | Predicted angular speed magnitude |

Shaders can sample the smoothed vectors directly for responsive-yet-stable motion, while still having access to the raw pose and derivative magnitudes for more reactive effects (e.g., bloom bursts on rapid head snaps). The projected values unlock prediction-aware effects such as late-latched reprojection or audio-synced anticipation glows without sacrificing the smoothed metrics.
