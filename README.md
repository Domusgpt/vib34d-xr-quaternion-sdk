...
- Ports the hypersphere/hypertetrahedron lattice shader to WGSL via the new `GlassShaderLibrary`, letting you swap geometry/projection pairs while keeping the WebGPU pipeline in sync with the legacy WebGL preview.
